                                ...
                                <div class="chat-left-sidebar">
                                    <div class="chat-admin">
                                        <div class="profile-wrap">
                                            <div class="user-img">
                                                <img src="{{ @globalAsset(auth()->user()->image->path) }}"
                                    ...
                                    <div class="chat-list-wrapper ">
                                        ...
                                        <div class="chat-list" data-url="{{ route('livechat.customer_chat_list') }}">
                                            {{-- <a class="single-chat " href="{{ route('livechat.chat', 1) }}">
                                                <div class="chat-cap">
                                                    <div class="user-img">
                                                        <img src="https://lms.onesttech.com/backend/uploads/default-images/default-1.jpeg"
                                                            alt="img" class="img-cover">
                                                    </div>
                                                    <div class="user-chat-caption">
                                                        <h5 class="user-name">Sami Alenzi</h5>
                                                        <p class="chat">Student</p>
                                                    </div>
                                                </div>
                                            </a> --}}
                                        </div>
