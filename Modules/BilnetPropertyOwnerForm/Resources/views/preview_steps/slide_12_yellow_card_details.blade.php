            ...
            <div class="d-flex flex-column flex-lg-row gap-4 gap-lg-0">
                ...
                <div class="profile-body">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="title">{{ _trans('Yellow Card Details (Optional)') }}</h2>
                    </div>
                    ...
                    <div class="profile-body-form">
                        ...
                        <div class="form-item">
                            <div class="d-flex justify-content-between align-content-center">
                                <div class="align-self-center">
                                    <h2 class="title">{{ _trans('common.Yellow Card Images') }}</h2>
                                    @if (!empty(@$data['yellow_card_images']))
                                        <div class="preview-image-container">
                                            @foreach (json_decode(@$data['yellow_card_images'], true) as $image)
                                                <div class="image-item">
                                                    <img src="{{ asset('storage/' . $image) }}" alt="Yellow Card Image"
                        ...
                        <div class="form-item">
                            <div class="d-flex justify-content-between align-content-center">
                                <div class="align-self-center">
                                    <h2 class="title">{{ _trans('common.Yellow Card Status') }}</h2>
                                    <p class="paragraph" data-name="yello_card_status" data-type="text">
                                        {{ @$data['yello_card_status'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item">
                            <div class="d-flex justify-content-between align-content-center">
                                <div class="align-self-center">
                                    <h2 class="title">{{ _trans('common.Yellow Card Time') }}</h2>
                                    <p class="paragraph" data-name="yello_card_time" data-type="text">
                                        {{ @$data['yello_card_time'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <x-navigation-links :previous="11" :next="13" />
