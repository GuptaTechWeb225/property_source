                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-7 col-sm-10">
                        <div class="footer-caption mb-50">
                            ...
                            <ul class="listing">
                                <li class="list"><a href="#" class="text-normal wow colorEffect fadeInUp"
                                                    data-wow-delay="0.1s"><i
                                            class="ri-mail-send-line"></i> {{ setting('email') }}</a></li>
                                <li class="list"><a href="#" class="wow colorEffect fadeInUp" data-wow-delay="0.1s"> <i
                                            class="ri-phone-fill"></i> {{ setting('phone_number') }}</a></li>
                                <li class="list"><a href="#" class="wow colorEffect fadeInUp" data-wow-delay="0.3s"> <i
