                    ...
                    <div class="col-xl-12">
                        <div class="ot-breadcrumb-inner-wrapper text-center">
                            <div class="breadcrumb-text">
                                <h3 class="title font-700">{{ _trans('landlord.Case Study details') }}</h3>
                                <div class="breadcrumb-links">
                                    <a class="breadcrumb-link" href="{{ route('home') }}">{{ _trans('landlord.Home') }}</a>
                                    <a href="/">{{ _trans('landlord.Case Study details') }}</a>
                                </div>
                                <div class="line-dro">
                ...
                <div class="col-xxl-8 col-xl-9">
                    ...
                    <div class="blog-details-wrapper mb-40">
                        <div class="details-img imgEffect radius-6 mb-35">
                            <img src="{{ @globalAsset($case_study->image->path) }}" alt="{{ $case_study->title }}">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-10">
                        ...
                        <div class="social-share footer-social2 mb-24">
                            <a href="https://www.facebook.com/{{ $case_study->slug }}" class="twitter wow fadeInDown" data-wow-delay="0.0s"><i class="ri-twitter-line"></i></a>
                            <a href="https://www.facebook.com/{{ $case_study->slug }}" class="linkedin wow fadeInDown" data-wow-delay="0.1s"><i class="ri-linkedin-fill"></i></a>
                            <a href="https://www.facebook.com/{{ $case_study->slug }}" class="facebook wow fadeInDown" data-wow-delay="0.2s"><i class="ri-facebook-fill"></i></a>
                            <a href="https://www.facebook.com/{{ $case_study->slug }}" class="share-btn ml-20 wow fadeInDown" data-wow-delay="0.3s"><i class="ri-share-line"></i></a>
                        </div>
                    </div>

                    <!-- Title -->
                    <div class="section-tittle-two mb-30">
                        <h2 class="title text-capitalize font-600">{{ $case_study->title }}</h2>
                    </div>
