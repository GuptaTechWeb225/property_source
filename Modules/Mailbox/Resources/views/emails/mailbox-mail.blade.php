    ...
    <div class="page-content">
        <div class="email-template">
            <div class="template-heading">
                <img class="half-logo" src="{{ globalAsset(@setting('light_logo')) }}" alt="img">
            </div>
            ...
            <div class="template-footer">
                <div class="template-footer-image">
                    <img class="full-logo" src="{{ globalAsset(@setting('light_logo')) }}" alt="img" />
                </div>
                <p>
                    {{ _trans('emailTemplate.Copyright') }} &copy; {{ date('Y') }} 
                    <a href="{{ url('/') }}">{{ @setting('application_name') }}</a>.
