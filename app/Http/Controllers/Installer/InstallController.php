...
class InstallController extends Controller
{
    ...
    public function CheckEnvironment()
    {
        ...
        $this->updateEnvValue('APP_NAME', 'LANDLORD');
    ...
    public function index()
    {
        ...
        $data['short_note'] = _trans('installer.Welcome, to complete the installation, please proceed to the next step!');
    ...
    public function DbSeed()
    {
        ...
        try {
            ...
            $sql = file_get_contents('installer/db/landlord.sql');
            DB::unprepared($sql);
    ...
    public function import_sql(Request $request)
    {
        ...
        $data['asset_path'] = $this->path;
        $data['sql'] = 'installer/db/landlord.sql';
        ...
        if (session('email') && session('password')) {
            if (!$this->updateDB()) {
                return redirect()->back()->with([
                    'error' => 'Import SQL file properly Or Check Database Credentials !',
                    'step' => 'AdminSetup',
                ]);
            }
        } else {
