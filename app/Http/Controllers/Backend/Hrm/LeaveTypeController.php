...
{
    protected LeaveTypeInterface $repository;
    protected $view_page = 'leave_type';
    protected $page_title = 'Leave Type';
    protected  $route = 'leavetype';

    public function __construct(LeaveTypeInterface $repository)
    {
