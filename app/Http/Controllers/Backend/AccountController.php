...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.account.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('backend.account.create')->with($data);
    }
    ...
    public function store(AccountStoreRequest $request)
    {
        try {
            ...
            return redirect()->route('account.index')->with('success', _trans('alert.account_created_successfully'));
        }catch (\Exception $exception){
            return redirect()->route('account.index')->with('danger', _trans('alert.'.$exception->getMessage()));
        }
    }
