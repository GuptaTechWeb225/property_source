    ...
    $(document).ready(function () {
        ...
        $("body").on("click", function (e) {
            if (
                ...
                $(".dropdown-menu, .select2-container").has(e.target).length ===
                    0
            ) {
        ...
        if (fileInp2) {
            ...
            function showFileName(event) {
                var fileInp2 = event.srcElement;
                var fileName2 = fileInp2.files[0].name;
                document.getElementById("placeholder2").placeholder = fileName2;
            }
        }
        if (fileInp3) {
        ...
        $(".update-data").hide();
        $(".add-edit-btn").click("on", function () {
            $(".load-data, .edit-section").hide();
            $(".update-data").show();
        });
    });
