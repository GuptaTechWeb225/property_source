...
@section('content')
<div class="order_tracking_area section_spacing6 pb-0">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8">
                <div class="tracking_form">
                    <h3 class="font_30 f_w_700 lh-1 mb_5">Track your Order</h3>
                    <p class="mb_55">Enter your Order ID in the box below and press the “Track” button.</p>
                    <form action="#">
                        <div class="row">
                            <div class="col-lg-12">
                                <label class="primary_label2 style2">Order Number</label>
                                <input name="name" placeholder="#84271327233" onfocus="this.placeholder = ''" onblur="this.placeholder = '#84271327233'" class="primary_input3 rounded-0 style2  mb_20" required="" type="text">
                            </div>
                            <div class="col-12">
                                <label class="primary_label2 style2">Phone Number</label>
                                <input name="name" placeholder="XXX-XXX-XXX" onfocus="this.placeholder = ''" onblur="this.placeholder = 'XXX-XXX-XXX'" class="primary_input3 rounded-0  mb_20 style2" required="" type="text">
                            </div>
                            <div class="col-12">
                                <button class="o_land_primary_btn  rounded-0  w-100 text-uppercase  text-center">Track Now</button>
                            </div>
                        </div>
                    </form>
                </div>
