        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="row">
                    <div class="col-12">
                        <div class="dashBoard_cart_boxs mb_25 ">
                            ...
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                ...
                                <span class="font_14 f_w_500"> Total Order</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                            <!-- single_items -->
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                <div class="icon d-flex align-items-center justify-content-center text-center">
                                ...
                                <span class="font_14 f_w_500">My Wishlist</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                            <!-- single_items -->
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                ...
                                <span class="font_14 f_w_500">Refund Success</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                            <!-- single_items -->
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                ...
                                <span class="font_14 f_w_500"> Product in Cart</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                            <!-- single_items -->
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                ...
                                <span class="font_14 f_w_500"> Coupon Used</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                            <!-- single_items -->
                            <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                ...
                                <span class="font_14 f_w_500"> Completed Order</span>
                                <h3 class=" font_20 f_w_700 m-0">23</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="dashboard_white_box bg-white mb_25 o_landy_full_height">
                            <div class="dashboard_white_box_header d-flex align-items-center gap_15 pb_10 mb_5">
                                ...
                                <a href="#" class="o_land_badge_btn3 text-uppercase text-nowrap">See all</a>
                            </div>
                                    ...
                                    <table class="table o_landy_table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="table_badge_btn style2 text-nowrap">Process</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="table_badge_btn text-nowrap style3">Cancel</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                    ...
                    <div class="col-lg-6 ">
                        <div class="dashboard_white_box bg-white mb_25 o_landy_full_height">
                            <div class="dashboard_white_box_header d-flex align-items-center gap_15 o_landy_bb3 pb_10 mb_5">
                                <h3 class="font_20 f_w_700 mb-0  flex-fill">My Wishlist</h3>
                                <a href="#" class="o_land_badge_btn2 text-uppercase">See all</a>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="dash_product_lists">
                                    <a href="{{route('properties.details')}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                        <div class="thumb">
                                            <img class="img-fluid" src="{{url('frontend/img/dashboard/products/1.png')}}" alt="">
                                        </div>
                                        <div class="dashboard_order_content">
                                            <h4 class="font_16 f_w_700 mb-1 lh-base theme_hover">Apartment in Hatirjhil</h4>
                                            <p class="font_14 f_w_500 d-flex align-items-center gap-2"> <span class="discount_prise text-decoration-line-through">$23.00</span> <span class="secondary_text">$20.00</span>  </p>
                                        </div>
                                    </a>
                                    <a href="{{route('properties.details')}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                        <div class="thumb">
                                            <img class="img-fluid" src="{{url('frontend/img/dashboard/products/2.png')}}" alt="">
                                        </div>
                                        <div class="dashboard_order_content">
                                            <h4 class="font_16 f_w_700 mb-1 lh-base theme_hover">Apartment in Hatirjhil</h4>
                                            <p class="font_14 f_w_500 d-flex align-items-center gap-2"> <span class="discount_prise text-decoration-line-through">$23.00</span> <span class="secondary_text">$20.00</span>  </p>
                                    ...
                                    <a href="{{route('properties.details')}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                        <div class="thumb">
                                            <img class="img-fluid" src="{{url('frontend/img/dashboard/products/3.png')}}" alt="">
                                        </div>
                                        <div class="dashboard_order_content">
                                            <h4 class="font_16 f_w_700 mb-1 lh-base theme_hover">Apartment in Hatirjhil</h4>
                                            <p class="font_14 f_w_500 d-flex align-items-center gap-2"> <span class="discount_prise text-decoration-line-through">$23.00</span> <span class="secondary_text">$20.00</span>  </p>
                                    ...
                                    <a href="{{route('properties.details')}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                        <div class="thumb">
                                            <img class="img-fluid" src="{{url('frontend/img/dashboard/products/4.png')}}" alt="">
                                        </div>
                                        <div class="dashboard_order_content">
                                            <h4 class="font_16 f_w_700 mb-1 lh-base theme_hover">Apartment in Hatirjhil</h4>
                                            <p class="font_14 f_w_500 d-flex align-items-center gap-2"> <span class="discount_prise text-decoration-line-through">$23.00</span> <span class="secondary_text">$20.00</span>  </p>
                    ...
                    <div class="col-xl-12">
                        <div class="o_land_cta_box2 mb_25">
                            <div class="row justify-content-end ">
                                <div class="col-xl-10 d-flex align-items-center gap-2 flex-wrap ">
                                    <div class="o_land_cta_text flex-fill">
                                        <span>Xiaomi MI Band 5</span>
                                        <h4>Bigger Dynamic</h4>
                                        <h5>Color range</h5>
                                    </div>
                                    <a href="#" class="o_land_white_btn min_170 lh-1">Explore Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
