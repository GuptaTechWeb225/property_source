...
@section('landlord_content')
    <x-landlord.container subtitle="Here's your documents for listed properties." tab="property">
        @forelse($properties as $property)
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-transparent border-0">
                    <h5>Documents of <span class="text-dark">{{ $property->name }}</span></h5>
                </div>
                <div class="card-body">
                    <div class="row">
