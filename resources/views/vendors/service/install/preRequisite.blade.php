        ...
        <div class="padding-left-top">
            ...
            <div class="bg-white w-75 rounded" step-count="2">
                <div class="text-title p-3 text-center text-white">
                    <h3>{{ _trans('service::install.environment_title') }}</h3>
                </div>
                <div class="row p-5">
