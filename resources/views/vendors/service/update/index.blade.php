                                ...
                                @if(gv($product, 'name'))
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="primary-btn fix-gr-bg" data-toggle="modal"
                                                data-target="#update_modal" data-modal-size="modal-md">Update
                                        </button>
                    ...
                    <div class="container-fluid">
                        <form method="POST" action="{{ route('service.download') }}" id="content_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" id="on_progress">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <button type="button" id="submitting" class="primary-btn fix-gr-bg submitting"
                                                disabled="">Updating...
                                        </button>
