                ...
                <div class="col-xl-12">
                    <div class="page-content">
                        ...
                        <div class="card mb-16 border-0 shadow-sm">
                            <div class="card-body">
                                <form action="{{ route('customer.account_category.store') }}" class="row align-items-center" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-lg-6 ot-contact-form mb-24">
                                        ...
                                        <input class="form-control ot-contact-input" name="name" type="text" placeholder="{{ _trans('common.Enter Here') }}">
                                        @error('name')
