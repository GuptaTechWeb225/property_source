                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6 mb-1">
                                                            {{ _trans('common.Date') }}: {{ @$item->start_date }}
                                                            @if ($item->end_date)
                                                                - {{ $item->end_date }}
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-1">
                                                            ...
                                                            {{ priceFormat($item->discount_amount) }}
                                                        </div>
                                                        <div class="col-md-6 mb-1">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6 mb-1">
                                                            {{ _trans('common.Payment Status') }}: <span
                                                                class="badges text-uppercase badge-bg-green">{{ $item->payment_status }}</span>
                                                        </div>
                                                        <div class="col-md-6 mb-1">
                                                            {{ _trans('common.Total Paid') }}:
                                                            {{ priceFormat($item->payments->sum('amount')) }}
                                                        </div>
                                                        <div class="col-md-6 mb-1">
                                                            {{ _trans('common.Due Amount') }}:
                                                            {{ priceFormat($item->total_amount - $item->payments->sum('amount')) }}
                                                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        @if (!empty($item->payments))
                                                            ...
                                                            @else
                                                                @if (hasPermission('order_payment'))
                                                                    <button
                                                                        onclick="calculatePaymentAmount({{ @$item->id }})"
                                                                        type="button" class="btn btn-primary ml-6"
                                                        ...
                                                        @if (!empty($item->advertisement))
                                                            @if ($item->advertisement->advertisement_type == \App\Enums\DealType::RENT)
                                                                @if ($item->advertisement->max_member <= count($item->familyMembers))
                                                                @endif
                                                                @if ($item->status == 'approved')
                                                                    <a href="{{ route('customer.family-member.create', ['id' => $item->id]) }}"
                                                                        type="button"
                                                                        class="btn-primary-outline text-uppercase ml-6">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{ _trans('common.Order Payment') }}</h5>
                                                    ...
                                                    <form action="{{ route('orders.payment') }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12 mb-3 mt-3">
                                                                ...
                                                                <input readonly class="form-control ot-input"
                                                            ...
                                                            <div class="col-md-12 mb-3 mt-3">
                                                                ...
                                                                <input type="number" required
                                                                    onkeyup="calculateDueAmount()" id="payment_amount"
                                                                    class="form-control ot-input" name="payment_amount"
                                                                    placeholder="{{ _trans('common.Payment Amount') }}">
                                                            </div>
                                                            <x-forms.select label="Accounts" :required="true"
                                                                name="account_id" col="col-lg-12 mb-4 mt-3">
                                                                <option value="">{{ _trans('common.Select One') }}
                                                                </option>
                                                            ...
                                                            @if (count($accounts) < 1)
                                                                <p class="text-danger">
                                                                    {{ _trans('common.The tenant has no account available!') }}
                                                                </p>
                                                            @endif
                                                            <div class="col-md-12 mb-3 mt-3">
                                                                <label for="address"
                                                                ...
                                                                <input readonly type="number"
                                                                    class="form-control ot-input" id="due_amount"
                                                                    name="due_amount"
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <textarea name="payment_details" id="payment_details" placeholder="{{ _trans('common.Payment Details') }}"
                                                                    class="form-control m-0 "></textarea>
                                                            </div>
                                                            <div class="col-md-12 mb-3 mt-3">

                                                                <label class="form-label"
                                                                    for="inputImage">{{ _trans('common.Attachment') }}
                                                                </label>
