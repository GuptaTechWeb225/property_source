...
@section('content')
    <div class="page-content">
                    ...
                    <h4 class="bradecrumb-title mb-1">{{ $data['title'] }}</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('properties.facilityType.index') }}">{{ _trans('landlord.Facility Type') }}</a>
                            </li>
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('properties.facilityType.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row mb-3">
