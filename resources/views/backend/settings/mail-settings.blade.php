    ...
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-header">
                <h4>{{ _trans('settings.email_settings') }}</h4>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.mail_host') }} <span
                                                class="fillable">*</span></label>
                                        <input type="text" name="mail_host"
                                            class="form-control ot-input @error('mail_host') is-invalid @enderror"
                                            value="{{ setting('mail_host') }}"
                                            placeholder="{{ _trans('settings.mail_host') }}">
                                        @error('mail_host')
                                    ...
                                    {{-- Mail drive start --}}
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.mail_username') }}
                                            <span class="fillable">*</span></label>
                                        <input type="text" name="mail_username"
                                               class="form-control ot-input @error('mail_username') is-invalid @enderror"
                                               value="{{ Setting('mail_username') }}"
                                               placeholder="{{ _trans('settings.mail_username') }}">
                                        @error('mail_username')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="exampleInputPassword1"
                                               class="form-label ">{{ _trans('settings.mail_password') }} <span
                                                class="fillable">*</span></label> <input type="text"
                                                                                         ...
                                                                                         placeholder="{{ _trans('settings.enter_your_mail_password') }}">
                                        @error('mail_password')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="exampleInputPassword1"
                                               class="form-label ">{{ _trans('settings.mail_port') }} <span
                                                class="fillable">*</span></label> <input type="text" name="mail_port"
                                                                                         ...
                                                                                         id="exampleInputmail_password1"
                                                                                         placeholder="{{ _trans('settings.enter_your_mail_post') }}">
                                        @error('mail_port')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <!-- Mail Password end -->
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.mail_address') }}
                                            <span class="fillable">*</span></label>
                                        <input type="text" name="mail_address"
                                            class="form-control ot-input @error('mail_address') is-invalid @enderror"
                                            value="{{ Setting('mail_address') }}"
                                            placeholder="{{ _trans('settings.mail_address') }}">
                                        @error('mail_address')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    {{-- Mail drive start --}}
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.from_name') }} <span
                                                class="fillable">*</span></label>
                                        <input type="text" name="from_name"
                                            class="form-control ot-input @error('from_name') is-invalid @enderror"
                                            value="{{ Setting('from_name') }}"
                                            placeholder="{{ _trans('settings.from_name') }}">
                                        @error('from_name')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
