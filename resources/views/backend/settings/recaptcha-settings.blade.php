    ...
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-header">
                <h4>{{ _trans('common.recaptcha_settings') }}</h4>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.recaptcha_sitekey') }}
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="inputname" class="form-label">{{ _trans('settings.recaptcha_secret') }}
                                            <span class="fillable">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                        <label for="validationServer04"
                                            class="form-label">{{ _trans('settings.recaptcha_status') }} <span
                                                class="fillable">*</span></label>
                                        <select
                                            class="nice-select niceSelect bordered_style wide @error('recaptcha_status') is-invalid @enderror"
