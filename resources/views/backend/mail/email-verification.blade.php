...
<head>
    ...
    <style>
        ...
        .email-template .template-button-group .template-btn {
            padding: 9px 2px;
            border-radius: 7px;
            background: linear-gradient(90deg, #0f6aff 0%, #c89c66 100%);
        }
...
<div class="page-content">
    ...
    <div class="email-template">
        ...
        <div class="template-heading">
            <!-- logo  -->
            <img style="height: 80px" src="{{ @globalAsset(setting('favicon')) }}" alt="Frame">
        </div>
        <!-- End template header  -->
        <!-- Start template body  -->
        <div class="template-body">
            ...
            <div class="content-part">
                ...
                <p>{{ _trans('landlord.welcome!') }}
                    <br> {{ _trans('landlord.are you receiving this email because you have registered on our site') }}
                </p>
        ...
        <div class="template-footer">
            <div class="template-footer-image">
                <!-- logo  -->
                <img style="width: 150px" src="{{ @globalAsset(setting('light_logo')) }}" alt="Logo">
            </div>
