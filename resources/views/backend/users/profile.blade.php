      ...
      <div class="d-flex flex-column flex-lg-row gap-4 gap-lg-0">
                ...
                <div class="profile-menu-head">
                  <div class="d-flex align-items-center">
                    <div class="image-box flex-shrink-0">
                      <img class="img-fluid rounded-circle" src="{{ asset('backend/assets/images/profile/user-avatar.jpg') }}"
                        alt="profile image" />
                    </div>
                    <div class="flex-grow-1">
                      <div class="body">
                        <h2 class="title">Robert Downey</h2>
                        <p class="paragraph">UI/UX Designer</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="profile-menu">
          ...
          <div class="profile-menu-head">
            <div class="d-flex align-items-center">
              <div class="image-box flex-shrink-0">
                <img class="img-fluid rounded-circle" src="{{ asset('backend/assets/images/profile/user-avatar.jpg') }}" alt="profile image" />
              </div>
              <div class="flex-grow-1">
                <div class="body">
                  <h2 class="title">Robert Downey</h2>
        ...
        <div class="profile-body">
          ...
          <nav>
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="./profile">Personal</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./profile-official">Official</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./profile-financial">Financial</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./profile-salary">Salary</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./profile-emergency">Emergency</a>
              </li>
              <li class="nav-item">
            ...
            <div class="form-item border-bottom-0 pb-0">
              <div class="image-box">
                <img id="id-profile-image" class="img-fluid rounded-circle"
                  src="{{ asset('backend/assets/images/profile/personal-avatar.jpg') }}" alt="profile avatar" />
            ...
            <div class="form-item">
              <div class="d-flex justify-content-between align-content-center">
                <div class="align-self-center">
                  ...
                  <p class="paragraph">Robert Downey JR.</p>
                </div>
                <div class="align-self-center">
              ...
              <div class="collapse" id="collapseName">
                <div class="form-box">
                  <form>
                    <input name="name" type="text" class="form-control ot-input" placeholder="Robert Downey JR." />
