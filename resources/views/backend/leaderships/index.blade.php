        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ _trans('common.leaderships') }}</h4>
                    @if (hasPermission('testimonial_create'))
                        <a href="{{ route('leaderships.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body ot-card">
                    <div class="table-responsive">
                        <table class="table table-bordered ot-table-bg testimonial-table">
                            ...
                            <tbody class="tbody">
                                @forelse ($data['leaderships'] as $key => $row)
                                    <tr id="row_{{ $row->id }}">
                                                        ...
                                                        @if (hasPermission('testimonial_update'))
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('leaderships.edit', $row->id) }}">
                                                        ...
                                                        @if (hasPermission('testimonial_delete'))
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                    onclick="delete_row('leaderships/delete', {{ $row->id }})">
