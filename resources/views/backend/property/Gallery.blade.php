                    ...
                    <div class="profile-body-form style-2">
                        ...
                        <div class="land-project-gallery">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="single-gallery-wrapper position-relative">
                                                <div class="action ">
                                                    ...
                                                    <a href="{{ route('properties.deleteImage', $gallery->image->id) }}"
                                                        class="btn btn-danger" type="submit">Delete</a>
                                                </div>
                                                <img class="img-fluid mb-24" src="{{ @globalAsset($gallery->image->path) }}"
                                                    alt="profile image" />
                                            </div>
                            ...
                            <form class="property-add-gallery"
                                action="{{ route('properties.update', [$data['property']->id, 'gallery']) }}" method="post"
                                id="visitForm" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">

                                    <div class="col-xl-12">
                                        <div class="title mb-10">
                                            <h3 class="">Add Gallery</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 mb-3">
                                        ...
                                        <input class="form-control ot-input @error('Title') is-invalid @enderror"
                                            ...
                                            placeholder="{{ _trans('common.Bedroom') }}">
                                        @error('Title')
