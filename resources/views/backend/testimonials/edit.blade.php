...
@section('content')
    <div class="page-content">
                ...
                <div class="col-sm-6">
                    <h4 class="bradecrumb-title mb-1">{{ $data['title'] }}</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('testimonials.index') }}">{{ $data['title'] }}</a>
                            </li>
        ...
        <div class="card ot-card">
            ...
            <div class="card-body">
                <form action="{{ route('testimonials.update', @$data['testimonial']->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                value="{{ @$data['testimonial']->name }}" list="datalistOptions" id="exampleDataList"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control ot-input @error('designation') is-invalid @enderror"
                                name="designation" value="{{ @$data['testimonial']->designation }}" list="datalistOptions"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control ot-input @error('message') is-invalid @enderror" name="message"
                                value="{{ @$data['testimonial']->message }}" list="datalistOptions" id="exampleDataList2"
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="nice-select niceSelect bordered_style wide @error('status') is-invalid @enderror"
                                ...
                                <option value="{{ App\Enums\Status::ACTIVE }}"
                                    {{ @$data['testimonial']->status == App\Enums\Status::ACTIVE ? 'selected' : '' }}>
                                    {{ _trans('common.active') }}
                                </option>
                                <option value="{{ App\Enums\Status::INACTIVE }}"
                                    {{ @$data['testimonial']->status == App\Enums\Status::INACTIVE ? 'selected' : '' }}>
