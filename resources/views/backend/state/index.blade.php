                    ...
                    <div class="row justify-content-between">
                                ...
                                <div class="form-group w-100">
                                    <select
                                        ...
                                        @foreach ($data['countries'] as $country)
                                            <option
                                                value="{{ $country->id }}"{{ old('country_id') == $country->id || request()->input('country_id') == $country->id ? 'selected' : '' }}>
                                                {{ $country->name }}</option>
                                        @endforeach
                        ...
                        <div class="col-md-2">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('states.create') }}" class="btn btn-lg ot-btn-primary text-right">
                ...
                <div class="card-body ot-card">
                    <div class="table-responsive">
                        <table class="table table-bordered ot-table-bg category-table">
                            ...
                            <tbody class="tbody">
                                @forelse ($data['states'] as $key => $row)
                                    <tr id="row_{{ $row->id }}">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                            onclick="delete_row('states/delete', {{ $row->id }})">
