...
@section('content')
    <div class="page-content">
                    ...
                    <h4 class="bradecrumb-title mb-1">{{ $data['title'] }}</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('categories.index') }}">{{ _trans('landlord.categories') }}</a>
                            </li>
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('categories.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="exampleDataList" class="form-label ">{{ _trans('landlord.Subtitle') }} <span
                                        class="fillable">*</span></label>
                                <input class="form-control ot-input @error('subtitle') is-invalid @enderror" name="subtitle"
                                    list="datalistOptions" id="exampleDataList"
                                    placeholder="{{ _trans('landlord.enter subtitle') }}">
                                @error('subtitle')
                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control ot-input @error('short_description') is-invalid @enderror"
                                    name="short_description" list="datalistOptions" id="exampleDataList"
                                    placeholder="{{ _trans('landlord.enter short description') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="exampleDataList" class="form-label ">{{ _trans('landlord.slug') }} <span
                                        class="fillable">*</span></label>
                                <input class="form-control ot-input @error('slug') is-invalid @enderror" name="slug"
                                    list="datalistOptions" id="exampleDataList"
                                    placeholder="{{ _trans('landlord.enter your slug') }}">
                                @error('slug')
                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
