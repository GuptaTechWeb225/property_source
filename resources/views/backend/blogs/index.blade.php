        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ _trans('landlord.blogs') }}</h4>
                    @if (hasPermission('blogs_create'))
                        <a href="{{ route('blogs.create') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body ot-card">
                                                    ...
                                                    @if (hasPermission('blogs_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                               href="{{ route('blogs.edit', $row->id) }}"><span
                                                                    class="icon mr-8"><i
                                                        ...
                                                        @if (hasPermission('blogs_delete'))
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                   onclick="delete_row('blog/delete', {{ $row->id }})">
                    ...
                    <!--  table end -->
                    <!--  pagination start -->
                    @if($data['blogs'] instanceof \Illuminate\Pagination\LengthAwarePaginator)
                        <div
