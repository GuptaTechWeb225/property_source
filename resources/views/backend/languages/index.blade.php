        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ _trans('common.languages') }}</h4>
                        ...
                        <table class="table table-bordered ot-table-bg language-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ _trans('common.code') }}</th>
                                    <th class="purchase">{{ _trans('common.icon') }}</th>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('languages.edit.terms', $row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                                            class="fa-solid fa-pen-to-square"></i></span>
                                                                    <span>{{ _trans('common.edit_terms') }}</span></a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </div>
