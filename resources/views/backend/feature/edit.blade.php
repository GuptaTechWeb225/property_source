...
@section('content')
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('features.index') }}">{{ $data['title'] }}</a></li>
        ...
        <div class="card ot-card">
            ...
            <div class="card-body">
                <form action="{{ route('features.update', @$data['feature']->id) }}" enctype="multipart/form-data" method="post"
                    id="visitForm">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        value="{{ @$data['feature']->title }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleInputEmail1" class="form-label">{{ _trans('landlord.Description') }} <span
                                            class="fillable">*</span></label>
                                            <input class="form-control ot-input @error('description') is-invalid @enderror" name="description"
                                            value="{{ @$data['feature']->description }}" list="datalistOptions" id="exampleDataList2"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    aria-describedby="validationServer04Feedback">
                                        ...
                                        <option value="{{ App\Enums\Status::ACTIVE }}"
                                            {{ @$data['feature']->status == App\Enums\Status::ACTIVE ? 'selected' : '' }}>
                                            {{ _trans('landlord.active') }}
                                        </option>
                                        <option value="{{ App\Enums\Status::INACTIVE }}"
                                            {{ @$data['feature']->status == App\Enums\Status::INACTIVE ? 'selected' : '' }}>
